  ...
  <div class="login-box-body">
    ...
    <form  method="post">
      <div class="form-group has-feedback">
        <input type="email" class="form-control" placeholder="Email"  id="emaillog" >
        <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <input type="password" class="form-control" placeholder="Password" id="passlog">
      ...
      <div class="row">
       <!--  <div class="col-xs-8">
        ...
        <!-- /.col -->
        <div class="col-xs-4">
          <button type="button" id="signin" style="float:left;" class="btn btn-primary btn-block btn-flat">Sign In</button>
